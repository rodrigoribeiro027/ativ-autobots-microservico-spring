...
public class VendaControle {
	...
	@Autowired
	private AdicionadorLinkVenda vendaLink;
	@Autowired
	...
	public ResponseEntity<?> excluirVenda(@PathVariable Long idVenda) {
		...
		if (verificador == null) {
			return new ResponseEntity<>("Venda não encontrada :D", HttpStatus.NOT_FOUND);
		} 
		else {
			...
			return new ResponseEntity<>("Venda excluída :D", HttpStatus.ACCEPTED);
		}
	}
